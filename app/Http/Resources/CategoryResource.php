    ...
    public function toArray($request) {
        if(!empty($this->resource)) {
            return [
                'name' => $this->name,
                'slug' => $this->slug,
                'image' => File::exists(public_path($this->image)) ? url('/') . '/' . $this->image : url('/') . '/uploads/custom-images/default.jpg',
                'products' => [
                    'id' => $this->id,
                    'name' => $this->name,
                    'shortName' => $this->short_name,
                    'slug' => $this->slug,
                    'image' => (!empty($this->thumb_image) && File::exists(public_path($this->thumb_image))) ? url('/') . '/' . $this->thumb_image : url('/') . '/uploads/custom-images/default.jpg',
                    'brand' => $this->brand_id,
                    'qty' => $this->sold_qty,

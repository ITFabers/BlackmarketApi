                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <?php var_dump($productSpecifications);var_dump($specificationKeys);
                                ...
                                @if ($product->is_specification==1)
                                    <div class="form-group col-12" id="specification-box">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-success plus_btn" id="addSpecificationRow"><i class="fas fa-plus"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div id="hidden-specification-box-new" class="d-none">
                                    <div class="delete-specification-row">
                                        <div class="row mt-2">
                                            <div class="col-md-5">
                                                <label>{{__('admin.Key')}} <span class="text-danger">*</span></label>
    ...
    (function($) {
        ...
        $(document).ready(function () {
            ...
            $("#addSpecificationRow").on('click',function(){
                var html = $("#hidden-specification-box-new").html();
                $("#specification-box").append(html);
            })

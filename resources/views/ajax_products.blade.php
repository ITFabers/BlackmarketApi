            ...
            <div class="col-xl-4  col-sm-6">
                <div class="wsus__product_item">
                    ...
                    <ul class="wsus__single_pro_icon">
                        <li><a data-bs-toggle="modal" data-bs-target="#productModalView-{{ $product->id }}"><i
                    ...
                    <div class="wsus__product_details">
                        ...
                        @else
                            <p class="wsus__price">{{ $currencySetting->currency_icon }}{{ sprintf("%.2f", $product->offer_price + $variantPrice) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="wsus__pro_details_text">
                                    ...
                                    @if ($product->qty == 0)
                                        <p class="wsus__stock_area"><span class="in_stock">{{__('Out of Stock')}}</span>
                                        </p>
                                    @else
                                    ...
                                    <form id="productModalFormId-{{ $product->id }}">
                                                    ...
                                                    @foreach ($productVariants as $productVariant)
                                                        ...
                                                        @if ($items->count() != 0)
                                                            <div class="col-xl-6 col-sm-6 mb-3">
                                                                ...
                                                                <select class="select_2 productModalVariant"
                                                                        name="items[]"
                                        ...
                                        <ul class="wsus__button_area">
                                            <li>
                                                <button type="button"
                                                        onclick="addToCartInProductModal('{{ $product->id }}')"
                                                        class="add_cart">{{__('add to cart')}}</button>
                                            </li>
                                            <li><a class="buy_now" href="javascript:;"
                                                   onclick="addToBuyNow('{{ $product->id }}')">{{__('buy now')}}</a>
                                            </li>
                                            <li><a href="javascript:;" onclick="addToWishlist('{{ $product->id }}')"><i

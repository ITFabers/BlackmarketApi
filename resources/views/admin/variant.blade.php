                            ...
                            <tbody>
                                @foreach ($variants as $index => $variant)
                                    <tr>
                                        ...
                                        <a href="{{ route('admin.product-variant-item',['variant_id'=>$variant->id]) }}" class="btn btn-success btn-sm"><i class="fas fa-cog" aria-hidden="true"></i> {{__('admin.manage options')}}</a>

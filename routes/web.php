...
use App\Http\Controllers\WEB\Admin\CustomerCardStatusController;
...
// Route::get('swagger-publish',function(){
//    Artisan::call('vendor:publish --provider "L5Swagger\L5SwaggerServiceProvider"');
// });

// Route::get('swagger',function(){
//    Artisan::call('vendor:publish --provider="Mpociot\ApiDoc\ApiDocGeneratorServiceProvider"');
// });
